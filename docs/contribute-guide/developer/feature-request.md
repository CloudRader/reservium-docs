...
## :fontawesome-solid-clipboard-list: Before Submitting

To help us process your request efficiently, please take a moment to:

*   **Check existing issues**: Search our [GitHub Issues](https://github.com/CloudRader/reservium-api/issues) to see if the feature has already been requested or discussed.
...
## :fontawesome-solid-file-circle-plus: How to Submit
...
1.  Navigate to the **[Reservium API Repository](https://github.com/CloudRader/reservium-api)**.
...
!!! tip "A Good Feature Request Includes..."
...
## :fontawesome-solid-clock-rotate-left: What Happens Next?
...
## :fontawesome-solid-wand-magic-sparkles: Tips for Success
...
## :fontawesome-solid-arrow-right-long: Ready to Start?

Head over to GitHub and let us know what you're thinking!

- **[Submit a Feature Request](https://github.com/CloudRader/reservium-api/issues/new)**
